...
\loadglsentries{./Chapitres/glossaire} %permet de faire le lien avec mon document de glossaire et de l'utiliser.
...
\printbibliography[title={Bibliographie exhaustive}] % pour certaines entrées, je n'ai pas d'auteur car il s'agit de blog ou article web anonyme. Malgré plusieurs recherches, aucun nom d'auteur est accessible.
...
\section{Recherche augmentée et \gls{chatbot} : état de l'art.}
...
\chapter[Traitement et indexation de l'\gls{imgani}]{Faciliter l’indexation par sa semi-automatisation : le cas de l’\gls{imgani}}

\section[Dans le logiciel Skinsoft]{La gestion de l’\gls{imgani} dans le logiciel SkinSoft}

\input{./Chapitres/P2_C2_1.tex}

\newpage

\section[Outils et réalité technique]{Les différentes réalités de l’indexation semi-automatisée : focus sur l’\gls{imgani}, un objet documentaire particulier.}
