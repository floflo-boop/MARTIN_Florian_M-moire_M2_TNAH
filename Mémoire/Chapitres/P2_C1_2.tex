...
\begin{tikzpicture}[
node distance=1.2cm,
% Définition  styles des noeuds et flèches
stepbox/.style={
rectangle,
draw=blue!80!black,
fill=blue!5,
...
% Création des flèches pour lier les noeuds
...
\begin{tikzpicture}[
node distance=1cm,
% Définitions du style des blocs et flèches
box/.style={
rectangle,
draw=blue!80!black,
fill=blue!5,
...
% Définition des flèches pour lier les noeuds
\draw [arrow] (e1) -- (e2);
\draw [arrow] (e2) -- (e3);
\draw [arrow] (e3) -- (e4);
\draw [arrow] (e4) -- (e5);
